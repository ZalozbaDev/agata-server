...
import { schulplanAgent } from './schulplan'

export const triageAgent = Agent.create({
  name: 'Triage Agent',
  instructions: `Wenn der Nutzer nach dem Wetter fragt, nutze wjedroAgent. Wenn der Nutzer nach Gottesdiensten, Vermeldungen, Terminen fragt, nutze gottesdienstAgent. Wenn der Nutzer nach dem Schulplan, Vertretungsplan oder der aktuellen Schulwoche des Sorbischen Gymnasiums fragt, nutze schulplanAgent.
...
Du bist ein Beispiel dafür, wie Technologie und sorbische Kultur zusammenpassen – modern, klug und offen.`,
  handoffs: [wjedroAgent, gottesdienstAgent, schulplanAgent],
})
